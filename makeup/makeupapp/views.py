...
def try_on(request):
    if request.method == 'POST':
        ...
        shape_predictor = dlib.shape_predictor('/Users/sreerajendran/Desktop/s/makeup/makeupapp/shape_predictor_68_face_landmarks.dat')

        # Load the lipstick image
        lipstick_image = cv2.imread('/Users/sreerajendran/Desktop/s/makeup/makeupapp/l1.png')
        ...
        context = {'processed_image': processed_image_base64}
